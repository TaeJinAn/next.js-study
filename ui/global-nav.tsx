...
export default function GlobalNav() {
  ...
  return (
    <>
      <div className="fixed top-0 z-10 flex-col w-full bg-white border border-gray-800 lg:bottom-0 lg:z-auto lg:border-b-0 lg:border-r lg:border-gray-800 lg:w-72">
